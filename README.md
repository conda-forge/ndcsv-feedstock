...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/ndcsv-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/ndcsv-feedstock)
...
Once the `conda-forge` channel has been enabled, `ndcsv` can be installed with:

```
conda install ndcsv
```

It is possible to list all of the versions of `ndcsv` available on your platform with:
